...
public class OneDollarBotController {
    ...
    @Autowired private OneDollarDatabaseService oneDollarDatabaseService;
    @Autowired private ImageUpdateService imageUpdateService;
    ...
    public ResponseEntity<?> post(@RequestBody Update update) throws IOException {
        ...
        keyboardMarkup.setKeyboard(Arrays.asList(Arrays.asList(GIVE_ONE_DOLLAR)));
